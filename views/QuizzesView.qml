...
Item {
    ...
    signal quizResponse(string response)
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: root.currentQuiz ? 
                              root.currentQuiz.questions[root.currentQuestionIndex].question : ""
                        font.pixelSize: 20
                        color: "white"
                        wrapMode: Text.Wrap
                        Layout.fillWidth: true
                    ...
                    GridLayout {
                        ...
                        Repeater {
                            model: root.currentQuiz ? 
                                   root.currentQuiz.questions[root.currentQuestionIndex].options : []
                            ...
                            delegate: Rectangle {
                                ...
                                property bool isSelected: {
                                    if (!root.currentQuiz) return false;
                                    if (!root.quizResponses[root.currentQuiz.id]) return false;
                                ...
                                MouseArea {
                                    anchors.fill: parent
                                    onClicked: root.quizResponse(modelData)
                                }
                            }
                        }
                    }
